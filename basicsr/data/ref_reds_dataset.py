...
class RefREDSDataset(data.Dataset):
    def __init__(self, opt):
        super(RefREDSDataset, self).__init__()
        self.opt = opt 
        ...
        blur_img_paths = sorted(glob.glob(os.path.join(self.root_dir, '{}_blur'.format(self.opt['phase']), '*/*.png')))
        # print(os.path.join(self.root_dir, '{}_blur_deblur'.format(self.opt['phase']), '*/*.png'))

        # Load the list of sharp image paths
        sharp_img_paths =sorted(glob.glob(os.path.join(self.root_dir, '{}_sharp'.format(self.opt['phase']), '*/*.png')))
